...
def check_spelling():
    ...
    cs=label(root,text="Correct test is :",font=("poppins",20),bg="#dae6f6",fg="#364971")
...
button=Button(root,text="Check",font=("arial",20,"bold"),fg="wgite",bg="red",command=check_spelling)
button.pack()
